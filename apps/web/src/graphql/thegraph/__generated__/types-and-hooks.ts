...
export type PoolTransactionsQuery = { __typename?: 'Query', mints: Array<{ __typename?: 'Mint', timestamp: any, owner: any, sender?: any, origin: any, amount0: any, amount1: any, amountUSD?: any, transaction: { __typename?: 'Transaction', id: string }, pool: { __typename?: 'Pool', token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } } }>, swaps: Array<{ __typename?: 'Swap', timestamp: any, origin: any, amount0: any, amount1: any, amountUSD: any, transaction: { __typename?: 'Transaction', id: string }, pool: { __typename?: 'Pool', token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } } }>, burns: Array<{ __typename?: 'Burn', timestamp: any, origin: any, amount: any, amount0: any, amount1: any, amountUSD?: any, transaction: { __typename?: 'Transaction', id: string }, pool: { __typename?: 'Pool', token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } } }> };

export type PoolsFromTokenAddressQueryVariables = Exact<{
...
export type PoolsFromTokenAddressQuery = { __typename?: 'Query', pools: Array<{ __typename?: 'Pool', id: string, txCount: any, totalValueLockedUSD: any, feeTier: any, token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } }> };
...
export type TransactionsQuery = { __typename?: 'Query', transactions: Array<{ __typename?: 'Transaction', id: string, timestamp: any, mints: Array<{ __typename?: 'Mint', owner: any, sender?: any, origin: any, amount0: any, amount1: any, amountUSD?: any, pool: { __typename?: 'Pool', token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } } }>, swaps: Array<{ __typename?: 'Swap', origin: any, amount0: any, amount1: any, amountUSD: any, pool: { __typename?: 'Pool', token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } } }>, burns: Array<{ __typename?: 'Burn', owner?: any, origin: any, amount0: any, amount1: any, amountUSD?: any, pool: { __typename?: 'Pool', token0: { __typename?: 'Token', id: string, symbol: string }, token1: { __typename?: 'Token', id: string, symbol: string } } }> }> };
...
export const PoolTransactionsDocument = gql`
    query PoolTransactions($address: String!, $first: Int, $skip: Int, $orderBy: Transaction_orderBy, $orderDirection: OrderDirection) {
  mints(
    first: $first
    skip: $skip
    orderBy: timestamp
...
/**
 * __usePoolTransactionsQuery__
 *
 * To run a query within a React component, call `usePoolTransactionsQuery` and pass it any options that fit your needs.
 * When your component renders, `usePoolTransactionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
...
export const PoolsFromTokenAddressDocument = gql`
    query PoolsFromTokenAddress($tokenAddress: String!, $skip: Int, $orderBy: Pool_orderBy, $orderDirection: OrderDirection) {
  pools(
...
/**
 * __usePoolsFromTokenAddressQuery__
 *
 * To run a query within a React component, call `usePoolsFromTokenAddressQuery` and pass it any options that fit your needs.
 * When your component renders, `usePoolsFromTokenAddressQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePoolsFromTokenAddressQuery({
 *   variables: {
...
export const TokenTransactionsDocument = gql`
    query TokenTransactions($address: String!, $first: Int, $skip: Int, $orderBy: Swap_orderBy, $orderDirection: OrderDirection) {
  swapsAs0: swaps(
    first: $first
    skip: $skip
    orderBy: $orderBy
...
/**
 * __useTokenTransactionsQuery__
 *
 * To run a query within a React component, call `useTokenTransactionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useTokenTransactionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
