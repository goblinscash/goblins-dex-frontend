        ...
        {chainId && migrator && (
          <ExternalLink href={getExplorerLink(chainId, migrator.address, ExplorerDataType.ADDRESS)}>
            <ThemedText.DeprecatedBlue display="inline">
              <Trans>Gobswap migration contract</Trans> ↗
        ...
        <AutoColumn gap="lg">
          ...
          {noLiquidity && (
            <BlueCard style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              >
                <Trans>
                  You are the first liquidity provider for this Gobswap V3 pool. Your liquidity will migrate at the
          ...
          {largePriceDifference ? (
            <YellowCard>
              ...
              <ThemedText.DeprecatedBody fontSize={14} style={{ marginTop: 8, fontWeight: 485 }}>
                <Trans>
                  You should only deposit liquidity into Gobswap V3 at a price you believe is correct. <br />
