...
export const FALLBACK_URLS = {
  ...
  [ChainId.SMARTBCH]: ['https://smartbch.fountainhead.cash/mainnet', 'https://rpc-goblins.dfd.cash/', 'https://global.uat.cash',
...
export const RPC_URLS = {
  ...
  [ChainId.SMARTBCH]: [`https://rpc-goblins.dfd.cash/`, ...FALLBACK_URLS[ChainId.SMARTBCH]],
}
