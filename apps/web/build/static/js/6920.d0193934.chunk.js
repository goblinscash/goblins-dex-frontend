...
`;var Ct=o(76743);const vt=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-aa759b09-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,Tt=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-aa759b09-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,Pt=j.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-aa759b09-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,$t=j.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-aa759b09-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,It=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-aa759b09-4"})`
  gap: 24px;
...
`,Dt=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-aa759b09-5"})`
  gap: 24px;
  padding: 20px;
...
`,St=(0,j.default)(J.xv).withConfig({displayName:"PoolDetails__TokenDetailsHeader",componentId:"sc-aa759b09-6"})`
  width: 100%;
  font-size: 24px;
  font-weight: 485;
  line-height: 32px;
`,_t=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LinksContainer",componentId:"sc-aa759b09-7"})`
  gap: 16px;
  width: 100%;
`;function Nt(){const{poolAddress:e,chainName:t}=(0,U.UO)(),o=(0,x._3)(t),r=o&&(0,x.Tz)(o),{data:l,loading:d}=kt(e??"",r),[c,p]=(0,y.useReducer)((e=>!e),!1),u=c?l?.token1:l?.token0,m=c?l?.token0:l?.token1,h=!t||!e||!(0,x._3)(t)||!(0,M.UJ)(e),f=!d&&!l||h,[g,j]=(0,y.useState)(a.oX.VOLUME),[b,w]=(0,y.useState)(a.E4.LINE);return f?(0,i.jsx)(Ct.default,{}):(0,i.jsxs)(vt,{children:[(0,i.jsxs)(Tt,{children:[(0,i.jsxs)(s.ZP,{gap:"lg",children:[(0,i.jsx)(P.G7,{chainId:r,poolAddress:e,token0:u,token1:m,loading:d}),(0,i.jsxs)(S.ZP,{justify:"space-between",children:[(0,i.jsx)(P.dG,{chainId:r,token0:u,token1:m,feeTier:l?.feeTier,toggleReversed:p,loading:d}),(0,i.jsx)(Pt,{})]}),(0,i.jsx)(T,{token0:u,token1:m,chartType:g,priceChartType:b,feeTier:l?.feeTier,volume:l?.poolDayData||[],loading:d})]}),(0,i.jsx)($t,{}),(0,i.jsx)(ht,{poolAddress:e,token0:u,token1:m,isReversed:c})]}),(0,i.jsxs)(It,{children:[(0,i.jsx)(Le,{chainId:r,token0:u,token1:m,feeTier:l?.feeTier,loading:d}),(0,i.jsx)(me,{poolData:l,isReversed:c,chainId:r,loading:d}),(0,i.jsxs)(Dt,{children:[(0,i.jsx)(St,{children:(0,i.jsx)(n.cC,{id:"Rj01Fz"})}),(0,i.jsxs)(_t,{children:[(0,i.jsx)(G,{address:e,chainId:r,tokens:[u,m],loading:d}),(0,i.jsx)(G,{address:u?.id,chainId:r,tokens:[u],loading:d}),(0,i.jsx)(G,{address:m?.id,chainId:r,tokens:[m],loading:d})]})]})]})]})}}}]);
//# sourceMappingURL=6920.d0193934.chunk.js.map