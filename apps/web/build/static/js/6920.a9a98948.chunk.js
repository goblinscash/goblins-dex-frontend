...
`,function(e){e.BUY="Buy",e.SELL="Sell",e.BURN="Burn",e.MINT="Mint"}(at||(at={}));var rt=o(59155),lt=o(84087),dt=o(33151);const ct=(0,j.default)(b.dL).withConfig({displayName:"PoolDetailsTransactionsTable__StyledExternalLink",componentId:"sc-a5447474-0"})`
  color: ${({theme:e})=>e.neutral2};
...
`;var kt=o(76743);const Ct=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-740bd352-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,vt=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-740bd352-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,Tt=j.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-740bd352-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,Pt=j.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-740bd352-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,$t=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-740bd352-4"})`
  gap: 24px;
...
`,It=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-740bd352-5"})`
  gap: 24px;
  padding: 20px;
