...
`,le=j.default.div.withConfig({displayName:"PoolDetailsStats__BalanceChartSide",componentId:"sc-a46f25ea-6"})`
  height: 8px;
...
`;var kt=o(76743);const Ct=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-b7d1d756-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,vt=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-b7d1d756-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,Tt=j.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-b7d1d756-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,Pt=j.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-b7d1d756-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,$t=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-b7d1d756-4"})`
  gap: 24px;
...
`,It=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-b7d1d756-5"})`
  gap: 24px;
  padding: 20px;
...
`,Dt=(0,j.default)(J.xv).withConfig({displayName:"PoolDetails__TokenDetailsHeader",componentId:"sc-b7d1d756-6"})`
  width: 100%;
  font-size: 24px;
  font-weight: 485;
  line-height: 32px;
`,St=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LinksContainer",componentId:"sc-b7d1d756-7"})`
  gap: 16px;
  width: 100%;
`;function _t(){const{poolAddress:e,chainName:t}=(0,U.UO)(),o=(0,x._3)(t),r=o&&(0,x.Tz)(o),{data:d,loading:l}=wt(e??"",r),[c,p]=(0,y.useReducer)((e=>!e),!1),u=c?d?.token1:d?.token0,m=c?d?.token0:d?.token1,h=!t||!e||!(0,x._3)(t)||!(0,M.UJ)(e),f=!l&&!d||h,[g,j]=(0,y.useState)(a.oX.VOLUME),[b,w]=(0,y.useState)(a.E4.LINE);return f?(0,i.jsx)(kt.default,{}):(0,i.jsxs)(Ct,{children:[(0,i.jsxs)(vt,{children:[(0,i.jsxs)(s.ZP,{gap:"lg",children:[(0,i.jsx)(P.G7,{chainId:r,poolAddress:e,token0:u,token1:m,loading:l}),(0,i.jsxs)(S.ZP,{justify:"space-between",children:[(0,i.jsx)(P.dG,{chainId:r,token0:u,token1:m,feeTier:d?.feeTier,toggleReversed:p,loading:l}),(0,i.jsx)(Tt,{})]}),(0,i.jsx)(T,{token0:u,token1:m,chartType:g,priceChartType:b,feeTier:d?.feeTier,volume:d?.poolDayData||[],loading:l})]}),(0,i.jsx)(Pt,{}),(0,i.jsx)(ht,{poolAddress:e,token0:u,token1:m,isReversed:c})]}),(0,i.jsxs)($t,{children:[(0,i.jsx)(Le,{chainId:r,token0:u,token1:m,feeTier:d?.feeTier,loading:l}),(0,i.jsx)(me,{poolData:d,isReversed:c,chainId:r,loading:l}),(0,i.jsxs)(It,{children:[(0,i.jsx)(Dt,{children:(0,i.jsx)(n.cC,{id:"Rj01Fz"})}),(0,i.jsxs)(St,{children:[(0,i.jsx)(G,{address:e,chainId:r,tokens:[u,m],loading:l}),(0,i.jsx)(G,{address:u?.id,chainId:r,tokens:[u],loading:l}),(0,i.jsx)(G,{address:m?.id,chainId:r,tokens:[m],loading:l})]})]})]})]})}}}]);
//# sourceMappingURL=6920.9a690223.chunk.js.map