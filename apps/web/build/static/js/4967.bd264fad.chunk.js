...
`,C=h.default.button.withConfig({displayName:"AddressSection__ContractAddress",componentId:"sc-65f6d5a3-1"})`
  ...
  min-height: 38px;
  padding: 0px;
`;function j({address:e}){return(0,s.jsxs)(f,{children:[(0,s.jsx)(x.Tv.SubHeaderSmall,{children:(0,s.jsx)(o.cC,{id:"TPQ9LW"})}),(0,s.jsx)(C,{children:(0,s.jsx)(x.Qv,{address:e,truncatedAddress:(0,m.Xn)(e,2,3)})})]})}var y=n(77489),k=n(46502),g=n(58114),w=n(46778),b=n(54078),v=n(379),T=n(89691),I=n(83787),D=n(12973),A=n(21309),B=n(78614),N=n(51119),S=n(39491),P=n(96439),$=n(18910),L=n(92686),_=n(63486),E=n(17358),M=n(21123),F=n(66644),H=n(82032),Z=n(70762),O=n(86147);O.ZP`
...
//# sourceMappingURL=4967.bd264fad.chunk.js.map