...
`;function fe({title:e,value:t,delta:o}){const{formatNumber:n,formatDelta:a}=(0,b.Gb)();return(0,i.jsxs)(ie,{children:[(0,i.jsx)(w.Tv.BodySecondary,{children:e}),(0,i.jsxs)(he,{children:[(0,i.jsx)(xe,{children:n({input:t,type:b.sw.FiatTokenStats})}),!!o&&(0,i.jsxs)(S.ZP,{width:"max-content",padding:"4px 0px",children:[(0,i.jsx)(X.Kx,{delta:o}),(0,i.jsx)(w.Tv.BodySecondary,{children:a(o)})]})]})]})}var ge=o(75422),ye=o(13691),je=o(6125),we=o(73474),ke=o(44488),be=o(51119),Ce=o(6681),ve=o(95267),Te=o(54311),Pe=o(17513),$e=o(51232);const Ie=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetailsStatsButtons__PoolDetailsStatsButtonsRow",componentId:"sc-e1598f45-0"})`
  gap: 12px;
  z-index: 1;
...
`,De=j.default.button.withConfig({displayName:"PoolDetailsStatsButtons__PoolButton",componentId:"sc-e1598f45-1"})`
  display: flex;
  flex-direction: row;
  ...
  ${w.iV}
`,Se=(0,j.default)(je.o).withConfig({displayName:"PoolDetailsStatsButtons__SwapIcon",componentId:"sc-e1598f45-2"})`
  fill: ${({theme:e})=>e.accent1};
  rotate: 90deg;
`,_e=(0,j.default)(Y.X).withConfig({displayName:"PoolDetailsStatsButtons__ButtonBubble",componentId:"sc-e1598f45-3"})`
  height: 44px;
  width: 175px;
  border-radius: 900px;
...
`,ze=(0,j.default)(w.Tv.Caption).withConfig({displayName:"PoolDetailsPositionsTable__RangeText",componentId:"sc-e4efa33-6"})`
  width: max-content;
  white-space: nowrap;
...
`;var bt=o(76743);const Ct=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-aced3385-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,vt=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-aced3385-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,Tt=j.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-aced3385-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,Pt=j.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-aced3385-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,$t=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-aced3385-4"})`
  gap: 24px;
...
`,It=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-aced3385-5"})`
  gap: 24px;
  padding: 20px;
...
`,Dt=(0,j.default)(J.xv).withConfig({displayName:"PoolDetails__TokenDetailsHeader",componentId:"sc-aced3385-6"})`
  width: 100%;
  font-size: 24px;
  font-weight: 485;
  line-height: 32px;
`,St=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LinksContainer",componentId:"sc-aced3385-7"})`
  gap: 16px;
  width: 100%;
`;function _t(){const{poolAddress:e,chainName:t}=(0,U.UO)(),o=(0,x._3)(t),r=o&&(0,x.Tz)(o),{data:l,loading:d}=kt(e??"",r),[c,p]=(0,y.useReducer)((e=>!e),!1),u=c?l?.token1:l?.token0,m=c?l?.token0:l?.token1,h=!t||!e||!(0,x._3)(t)||!(0,M.UJ)(e),f=!d&&!l||h,[g,j]=(0,y.useState)(a.oX.VOLUME),[w,k]=(0,y.useState)(a.E4.LINE);return f?(0,i.jsx)(bt.default,{}):(console.log(l,"<====poolData"),(0,i.jsxs)(Ct,{children:[(0,i.jsxs)(vt,{children:[(0,i.jsxs)(s.ZP,{gap:"lg",children:[(0,i.jsx)(P.G7,{chainId:r,poolAddress:e,token0:u,token1:m,loading:d}),(0,i.jsxs)(S.ZP,{justify:"space-between",children:[(0,i.jsx)(P.dG,{chainId:r,token0:u,token1:m,feeTier:l?.feeTier,toggleReversed:p,loading:d}),(0,i.jsx)(Tt,{})]}),(0,i.jsx)(T,{token0:u,token1:m,chartType:g,priceChartType:w,feeTier:l?.feeTier,volume:l?.poolDayData||[],loading:d})]}),(0,i.jsx)(Pt,{}),(0,i.jsx)(ht,{poolAddress:e,token0:u,token1:m,isReversed:c})]}),(0,i.jsxs)($t,{children:[(0,i.jsx)(Le,{chainId:r,token0:u,token1:m,feeTier:l?.feeTier,loading:d}),(0,i.jsx)(me,{poolData:l,isReversed:c,chainId:r,loading:d}),(0,i.jsxs)(It,{children:[(0,i.jsx)(Dt,{children:(0,i.jsx)(n.cC,{id:"Rj01Fz"})}),(0,i.jsxs)(St,{children:[(0,i.jsx)(G,{address:e,chainId:r,tokens:[u,m],loading:d}),(0,i.jsx)(G,{address:u?.id,chainId:r,tokens:[u],loading:d}),(0,i.jsx)(G,{address:m?.id,chainId:r,tokens:[m],loading:d})]})]})]})]}))}}}]);
//# sourceMappingURL=6920.89b89f35.chunk.js.map