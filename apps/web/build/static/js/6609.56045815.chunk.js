...
`;var Zt=o(76743);const Rt=(0,b.default)(N.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-d7a22450-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,At=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-d7a22450-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,Ht=b.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-d7a22450-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,Vt=b.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-d7a22450-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,Wt=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-d7a22450-4"})`
  gap: 24px;
...
`,zt=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-d7a22450-5"})`
  gap: 24px;
  padding: 20px;
...
`,Gt=(0,b.default)(te.xv).withConfig({displayName:"PoolDetails__TokenDetailsHeader",componentId:"sc-d7a22450-6"})`
  width: 100%;
  font-size: 24px;
  font-weight: 485;
  line-height: 32px;
`,Xt=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__LinksContainer",componentId:"sc-d7a22450-7"})`
  gap: 16px;
  width: 100%;
...
//# sourceMappingURL=6609.56045815.chunk.js.map