...
`;function b({id:e,className:t="recipient-address-input",label:n,placeholder:c,value:b,onChange:j}){const{chainId:C}=(0,o.useWeb3React)(),v=(0,d.useTheme)(),{address:w,loading:T,name:I}=(0,p.Z)(b),N=(0,r.useCallback)((e=>{const t=e.target.value.replace(/\s+/g,"");j(t)}),[j]),E=Boolean(b.length>0&&!T&&!w);return(0,a.jsx)(f,{id:e,children:(0,a.jsx)(g,{error:E,children:(0,a.jsx)(x,{children:(0,a.jsxs)(m.Tz,{gap:"md",children:[(0,a.jsxs)(h.m0,{children:[(0,a.jsx)(l.Tv.DeprecatedBlack,{color:v.neutral2,fontWeight:535,fontSize:14,children:n??(0,a.jsx)(i.cC,{id:"I3QpvQ"})}),w&&C&&(0,a.jsx)(l.dL,{href:(0,u.E)(C,I??w,u.r.ADDRESS),style:{fontSize:"14px"},children:(0,a.jsx)(i.cC,{id:"4MNk2N"})})]}),(0,a.jsx)(y,{className:t,type:"text",autoComplete:"off",autoCorrect:"off",autoCapitalize:"off",spellCheck:"false",placeholder:c??s.ag._({id:"Eg2mpp"}),error:E,pattern:"^(0x[a-fA-F0-9]{40})$",onChange:N,value:b})]})})})})}},28243:(e,t,n)=>{n.d(t,{Z:()=>z});var a=n(21339),i=n(88693),s=n(56542),o=n(75422),r=n(4570),d=n(29826),l=n(82523),c=n(52214),p=n(25400),u=n(39491),m=n(33552),h=n(39681),f=n(10548),g=n(96193),x=n(19369),y=n(73685),b=n(61265),j=n(70357),C=n(94727),v=n(44680),w=n(73392),T=n(17358),I=n(41726),N=n(51764);const E=m.default.div.withConfig({displayName:"CurrencyInputPanel__InputPanel",componentId:"sc-98af073f-0"})`
  ...
  will-change: height;
`,_=m.default.div.withConfig({displayName:"CurrencyInputPanel__Container",componentId:"sc-98af073f-1"})`
  border-radius: ${({hideInput:e})=>e?"16px":"20px"};
  border: 1px solid ${({theme:e})=>e.surface3};
  background-color: ${({theme:e})=>e.surface2};
  width: ${({hideInput:e})=>e?"100%":"initial"};
  ${({theme:e,hideInput:t,disabled:n})=>!n&&`\n    :focus,\n    :hover {\n      border: 1px solid ${t?" transparent":e.surface2};\n    }\n  `}
`,D=(0,m.default)(j.Ux).withConfig({displayName:"CurrencyInputPanel__CurrencySelect",componentId:"sc-98af073f-2"})`
  align-items: center;
...
`,k=m.default.div.withConfig({displayName:"CurrencyInputPanel__InputRow",componentId:"sc-98af073f-3"})`
  ${g.MG};
  align-items: center;
  justify-content: space-between;
  padding: ${({selected:e})=>e?" 1rem 1rem 0.75rem 1rem":"1rem 1rem 1rem 1rem"};
`,S=m.default.div.withConfig({displayName:"CurrencyInputPanel__LabelRow",componentId:"sc-98af073f-4"})`
  ${g.MG};
  align-items: center;
...
`,A=(0,m.default)(S).withConfig({displayName:"CurrencyInputPanel__FiatRow",componentId:"sc-98af073f-5"})`
  justify-content: flex-end;
  padding: 0px 1rem 0.75rem;
  height: 32px;
`,P=m.default.span.withConfig({displayName:"CurrencyInputPanel__Aligner",componentId:"sc-98af073f-6"})`
  display: flex;
  align-items: center;
  justify-content: space-between;
  width: 100%;
  line-height: 0px;
`,M=(0,m.default)(y.r).withConfig({displayName:"CurrencyInputPanel__StyledDropDown",componentId:"sc-98af073f-7"})`
...
`,$=m.default.button.withConfig({displayName:"CurrencyInputPanel__StyledBalanceMax",componentId:"sc-98af073f-9"})`
...
`,W=(0,m.default)(w.I).withConfig({displayName:"CurrencyInputPanel__StyledNumericalInput",componentId:"sc-98af073f-10"})`
  ${d._Q};
  text-align: left;
`,O=(0,m.default)(l.Z).withConfig({displayName:"CurrencyInputPanel__StyledPrefetchBalancesWrapper",componentId:"sc-98af073f-11"})`
...
//# sourceMappingURL=123.623967bb.chunk.js.map