...
`,W=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetailsLink__CopyAddress",componentId:"sc-15d87bb3-3"})`
  ...
  flex-shrink: 0;
  ${b.iV}
`,z=(0,j.default)(L.Z).withConfig({displayName:"PoolDetailsLink__StyledCopyIcon",componentId:"sc-15d87bb3-4"})`
  width: 16px;
  height: 16px;
  color: ${({theme:e})=>e.neutral2};
  flex-shrink: 0;
`,V=j.default.div.withConfig({displayName:"PoolDetailsLink__ExplorerWrapper",componentId:"sc-15d87bb3-5"})`
  padding: 8px;
  border-radius: 20px;
  background-color: ${({theme:e})=>e.surface3};
  display: flex;
...
`,pe=(0,j.default)(Y.X).withConfig({displayName:"PoolDetailsStats__StatHeaderBubble",componentId:"sc-a46f25ea-8"})`
  ...
  height: 24px;
  border-radius: 8px;
`,me=({token:e,chainId:t})=>{const o=(0,Q.e)().lg,{formatNumber:n}=(0,k.Gb)();return(0,i.jsxs)(ae,{children:[!o&&(0,i.jsx)(D.Z,{currency:e.currency,size:"20px",style:{marginRight:"8px"}}),n({input:e.tvl,type:k.sw.TokenQuantityStats}),"\xa0",(0,i.jsxs)(se,{to:(0,x.dG)({address:e.id,chain:(0,x.Ld)(t),isInfoExplorePageEnabled:!0}),children:[o&&(0,i.jsx)(D.Z,{currency:e.currency,size:"16px",style:{marginRight:"4px",marginLeft:"4px"}}),e.symbol]})]})};function ue({poolData:e,isReversed:t,chainId:o,loading:a}){const r=(0,Q.e)().lg,l=(0,j.useTheme)(),d=(0,f.U8)(e?.token0?.id,o)??void 0,c=(0,f.U8)(e?.token1?.id,o)??void 0,p=(0,q.r)(d,l.surface2,l.darkMode);let m=(0,q.r)(c,l.surface2,l.darkMode);p===m&&p===l.accent1&&(m=ee.O9.blue400);const[u,h]=(0,y.useMemo)((()=>{if(e){const o=e?.tvlToken0/e?.token0Price+e?.tvlToken1,i={...e?.token0,price:e?.token0Price,tvl:e?.tvlToken0,color:p,percent:e?.tvlToken0/e?.token0Price/o,currency:d},n={...e?.token1,price:e?.token1Price,tvl:e?.tvlToken1,color:m,percent:e?.tvlToken1/o,currency:c};return t?[n,i]:[i,n]}return[void 0,void 0]}),[p,m,d,c,t,e]),x=(0,y.useMemo)((()=>e&&e.poolDayData&&e.poolDayData.length?e.poolDayData.reduce(((e,t)=>t.date>e.date?t:e),e.poolDayData[0]):0),[e?.poolDayData]);return!a&&u&&h&&e&&x?(0,i.jsxs)(oe,{loaded:!0,children:[(0,i.jsx)(te,{children:(0,i.jsx)(n.cC,{id:"29Hx9U"})}),(0,i.jsxs)(ie,{children:[(0,i.jsx)(b.Tv.BodySecondary,{children:(0,i.jsx)(n.cC,{id:"2mfj90"})}),(0,i.jsxs)(ne,{children:[(0,i.jsx)(me,{token:u,chainId:o}),(0,i.jsx)(me,{token:h,chainId:o})]}),r&&(0,i.jsxs)(S.ZP,{"data-testid":"pool-balance-chart",children:[u.color&&(0,i.jsx)(de,{percent:u.percent,$color:u.color,isLeft:!0}),h.color&&(0,i.jsx)(de,{percent:h.percent,$color:h.color,isLeft:!1})]})]}),(0,i.jsx)(fe,{title:(0,i.jsx)(n.cC,{id:"FHKsZF"}),value:e.tvlUSD,delta:e.tvlUSDChange}),(0,i.jsx)(fe,{title:(0,i.jsx)(n.cC,{id:"0RweTm"}),value:x.volumeUSD,delta:e.volumeUSDChange}),(0,i.jsx)(fe,{title:(0,i.jsx)(n.cC,{id:"PpS90j"}),value:x.feesUSD})]}):(0,i.jsxs)(oe,{children:[(0,i.jsx)(te,{children:(0,i.jsx)(pe,{})}),Array.from({length:4}).map(((e,t)=>(0,i.jsxs)(s.ZP,{gap:"md",children:[(0,i.jsx)(R.k,{}),(0,i.jsx)(ce,{})]},`loading-info-row-${t}`)))]})}const he=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetailsStats__StatsTextContainer",componentId:"sc-a46f25ea-9"})`
  gap: 4px;
  width: 100%;
...
`,Ve=(0,j.default)(b.Tv.Caption).withConfig({displayName:"PoolDetailsPositionsTable__RangeText",componentId:"sc-e4efa33-6"})`
  width: max-content;
  white-space: nowrap;
...
`;var kt=o(76743);const Ct=(0,j.default)(S.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-77b95794-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,vt=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-77b95794-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,Tt=j.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-77b95794-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,Pt=j.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-77b95794-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,$t=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-77b95794-4"})`
  gap: 24px;
...
`,It=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-77b95794-5"})`
  gap: 24px;
  padding: 20px;
...
`,Dt=(0,j.default)(J.xv).withConfig({displayName:"PoolDetails__TokenDetailsHeader",componentId:"sc-77b95794-6"})`
  width: 100%;
  font-size: 24px;
  font-weight: 485;
  line-height: 32px;
`,St=(0,j.default)(s.ZP).withConfig({displayName:"PoolDetails__LinksContainer",componentId:"sc-77b95794-7"})`
  gap: 16px;
  width: 100%;
`;function _t(){const{poolAddress:e,chainName:t}=(0,U.UO)(),o=(0,x._3)(t),r=o&&(0,x.Tz)(o),{data:l,loading:d}=wt(e??"",r),[c,p]=(0,y.useReducer)((e=>!e),!1),m=c?l?.token1:l?.token0,u=c?l?.token0:l?.token1,h=!t||!e||!(0,x._3)(t)||!(0,M.UJ)(e),f=!d&&!l||h,[g,j]=(0,y.useState)(a.oX.VOLUME),[b,w]=(0,y.useState)(a.E4.LINE);return f?(0,i.jsx)(kt.default,{}):(0,i.jsxs)(Ct,{children:[(0,i.jsxs)(vt,{children:[(0,i.jsxs)(s.ZP,{gap:"lg",children:[(0,i.jsx)(P.G7,{chainId:r,poolAddress:e,token0:m,token1:u,loading:d}),(0,i.jsxs)(S.ZP,{justify:"space-between",children:[(0,i.jsx)(P.dG,{chainId:r,token0:m,token1:u,feeTier:l?.feeTier,toggleReversed:p,loading:d}),(0,i.jsx)(Tt,{})]}),(0,i.jsx)(T,{token0:m,token1:u,chartType:g,priceChartType:b,feeTier:l?.feeTier,volume:l?.poolDayData||[],loading:d})]}),(0,i.jsx)(Pt,{}),(0,i.jsx)(ht,{poolAddress:e,token0:m,token1:u,isReversed:c})]}),(0,i.jsxs)($t,{children:[(0,i.jsx)(Le,{chainId:r,token0:m,token1:u,feeTier:l?.feeTier,loading:d}),(0,i.jsx)(ue,{poolData:l,isReversed:c,chainId:r,loading:d}),(0,i.jsxs)(It,{children:[(0,i.jsx)(Dt,{children:(0,i.jsx)(n.cC,{id:"Rj01Fz"})}),(0,i.jsxs)(St,{children:[(0,i.jsx)(G,{address:e,chainId:r,tokens:[m,u],loading:d}),(0,i.jsx)(G,{address:m?.id,chainId:r,tokens:[m],loading:d}),(0,i.jsx)(G,{address:u?.id,chainId:r,tokens:[u],loading:d})]})]})]})]})}}}]);
//# sourceMappingURL=6920.2f2dcbef.chunk.js.map