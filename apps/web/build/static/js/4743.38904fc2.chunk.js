...
`,I=f.default.span.withConfig({displayName:"Menu__MenuFlyout",componentId:"sc-ac391358-2"})`
  ...
  ${({flyoutAlignment:e=b.RIGHT})=>e===b.RIGHT?f.css`
          right: 0rem;
        `:f.css`
          left: 0rem;
        `};
...
`,ae=(0,f.default)(R.m0).withConfig({displayName:"Pool__TitleRow",componentId:"sc-d6a0ab30-1"})`
  color: ${({theme:e})=>e.neutral2};
  @media (max-width: ${({theme:e})=>`${e.breakpoint.sm}px`}) {
    flex-wrap: wrap;
    gap: 12px;
...
`,de=(0,f.default)(R.DA).withConfig({displayName:"Pool__ButtonRow",componentId:"sc-d6a0ab30-2"})`
  & > *:not(:last-child) {
    margin-left: 8px;
  }
...
`,le=(0,f.default)((({flyoutAlignment:e=b.RIGHT,ToggleUI:t,menuItems:n,...i})=>{const o=(0,h.useRef)(),r=(0,C.Wt)(k.Lk.POOL_OVERVIEW_OPTIONS),a=(0,C.xk)(k.Lk.POOL_OVERVIEW_OPTIONS);(0,v.t)(o,r?a:void 0);const d=t||O;return(0,s.jsxs)(_,{ref:o,...i,children:[(0,s.jsx)(d,{onClick:a}),r&&(0,s.jsx)(I,{flyoutAlignment:e,children:n.map((({content:e,link:t,external:n},i)=>n?(0,s.jsx)(L,{href:t,children:e},i):(0,s.jsx)(P,{to:t,children:e},i)))})]})})).withConfig({displayName:"Pool__PoolMenu",componentId:"sc-d6a0ab30-3"})`
  margin-left: 0;
  @media (max-width: ${({theme:e})=>`${e.breakpoint.sm}px`}) {
    flex: 1 1 auto;
    width: 50%;
...
`,ce=f.default.div.withConfig({displayName:"Pool__PoolMenuItem",componentId:"sc-d6a0ab30-4"})`
  align-items: center;
  display: flex;
  justify-content: space-between;
  width: 100%;
  font-weight: 535;
`,pe=(0,f.default)(x.Ux).withConfig({displayName:"Pool__MoreOptionsButton",componentId:"sc-d6a0ab30-5"})`
  border-radius: 12px;
  flex: 1 1 auto;
  padding: 6px 8px;
  width: 100%;
  ...
  margin-right: 8px;
`,xe=(0,f.default)(g.Tv.BodyPrimary).withConfig({displayName:"Pool__MoreOptionsText",componentId:"sc-d6a0ab30-6"})`
  align-items: center;
  display: flex;
`,ue=f.default.div.withConfig({displayName:"Pool__ErrorContainer",componentId:"sc-d6a0ab30-7"})`
  align-items: center;
  display: flex;
  flex-direction: column;
  justify-content: center;
...
`,me=(0,f.default)(U.Z).withConfig({displayName:"Pool__NetworkIcon",componentId:"sc-d6a0ab30-8"})`
  ${he}
`,fe=(0,f.default)(A.Z).withConfig({displayName:"Pool__InboxIcon",componentId:"sc-d6a0ab30-9"})`
  ${he}
`,ge=(0,f.default)(x.DF).withConfig({displayName:"Pool__ResponsiveButtonPrimary",componentId:"sc-d6a0ab30-10"})`
  border-radius: 12px;
  font-size: 16px;
  padding: 6px 8px;
  width: fit-content;
...
`,je=f.default.main.withConfig({displayName:"Pool__MainContentWrapper",componentId:"sc-d6a0ab30-11"})`
  background-color: ${({theme:e})=>e.surface1};
  border: 1px solid ${({theme:e})=>e.surface3};
  padding: 0;
  border-radius: 16px;
