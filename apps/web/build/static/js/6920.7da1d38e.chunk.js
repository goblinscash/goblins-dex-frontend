...
`;var It=o(76743);const $t=(0,b.default)(L.ZP).withConfig({displayName:"PoolDetails__PageWrapper",componentId:"sc-e63edb2-0"})`
  padding: 48px;
  width: 100%;
  align-items: flex-start;
  gap: 60px;
...
`,St=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__LeftColumn",componentId:"sc-e63edb2-1"})`
  gap: 24px;
  width: 65vw;
  overflow: hidden;
...
`,_t=b.default.div.withConfig({displayName:"PoolDetails__ChartTypeSelectorContainer",componentId:"sc-e63edb2-2"})`
  display: flex;
  gap: 8px;
  align-items: center;
`,Dt=b.default.hr.withConfig({displayName:"PoolDetails__HR",componentId:"sc-e63edb2-3"})`
  border: 0.5px solid ${({theme:e})=>e.surface3};
  margin: 16px 0px;
  width: 100%;
`,Nt=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__RightColumn",componentId:"sc-e63edb2-4"})`
  gap: 24px;
...
`,Lt=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__TokenDetailsWrapper",componentId:"sc-e63edb2-5"})`
  gap: 24px;
  padding: 20px;
...
`,Bt=(0,b.default)(oe.xv).withConfig({displayName:"PoolDetails__TokenDetailsHeader",componentId:"sc-e63edb2-6"})`
  width: 100%;
  font-size: 24px;
  font-weight: 485;
  line-height: 32px;
`,Et=(0,b.default)(s.ZP).withConfig({displayName:"PoolDetails__LinksContainer",componentId:"sc-e63edb2-7"})`
  gap: 16px;
  width: 100%;
...
//# sourceMappingURL=6920.7da1d38e.chunk.js.map